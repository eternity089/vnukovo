                ...
                {options.map((item) => {
                    ...
                    return (
                        <div key={item.id} className="flex items-center gap-2">
                            ...
                            />
                            {item.modal && (
                                 <button type="button" onClick={() => onOpenModal(item.modal)} className="flex items-center justify-center w-6 h-6 rounded-full border border-gray-400 text-gray-500 hover:text-h hover:border-h transition">
